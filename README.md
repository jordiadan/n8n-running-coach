...
- Set `INTERVALS_ICU_BASIC_AUTH='Basic <base64(API_KEY:API_KEY)>'` as the primary Intervals.icu auth secret in production.
- Optional alias: `INTERVALS_AUTH_HEADER` is accepted as fallback.
